          ...
          <div class="navbar-start">
            <div class="dropdown">
              ...
              <ul tabindex="0"
                ...
                <li>
                  <router-link to="/pinay/most-longest" class="py-2 hover:bg-red-600/50 rounded-lg transition-colors">
                    Most Longest
                  </router-link>
                </li>
              </ul>
            </div>
            <router-link to="/" class="text-3xl md:text-4xl font-bold tracking-tight ml-2 text-white">
              PINAYFLIX
            </router-link>
          </div>
