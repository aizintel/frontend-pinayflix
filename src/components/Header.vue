        ...
        <div class="navbar py-4 flex items-center justify-between">
          ...
          <div class="flex items-center gap-4">
            <div class="dropdown lg:hidden">
              <div tabindex="0" role="button" class="btn btn-ghost text-white p-0 m-0">
              ...
              <ul tabindex="0"
                class="menu menu-sm dropdown-content mt-3 p-3 shadow-lg bg-black/95 rounded-box w-60 text-white z-30">
                <li>
                ...
                <li>
                  <router-link to="/pinay/most-longest" class="px-4 hover:bg-red-600/30 rounded-lg transition-colors">
                    Most Longest
                  </router-link>
                </li>
              </ul>
            ...
            <router-link to="/" class="text-3xl md:text-4xl font-bold tracking-tight text-white">
              PINAYFLIX
            </router-link>
