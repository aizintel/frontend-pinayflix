...
const handleKeyDown = (e: KeyboardEvent) => {
  // Close mobile menu or search with Escape key
  if (e.key === 'Escape') {
      ...
      <div class="container mx-auto px-4">
        <div class="navbar h-16 md:h-20 flex items-center justify-between">
          ...
          <div class="flex items-center gap-2 md:gap-4">
            ...
            <!-- Logo -->
            <router-link to="/" class="text-2xl md:text-3xl font-bold tracking-tight text-white flex items-center" @click="closeMobileMenu">
...
#mobile-menu nav a:nth-child(4) { --index: 4; }
